...
impl Settings {
    ...
    pub fn for_area(&self, area: &Area) -> (bool, bool) {
        match area {
            ...
            Area::LIV_M99AA => (self.LIV_M99AA, self.LIV_M99AA_unlim),
            Area::STUNT_00 => (self.STUNT_00, self.STUNT_00_unlim),
            Area::STUNT_03A => (self.STUNT_03A, self.STUNT_03A_unlim),
            Area::STUNT_06 => (self.STUNT_06, self.STUNT_06_unlim),
            Area::STUNT_07 => (self.STUNT_07, self.STUNT_07_unlim),
            Area::M12AB => (self.M12AB, self.M12AB_unlim),
            Area::STUNT_12 => (self.STUNT_12, self.STUNT_12_unlim),
            Area::STUNT_14 => (self.STUNT_14, self.STUNT_14_unlim),
            Area::STUNT_16 => (self.STUNT_16, self.STUNT_16_unlim),
            Area::STUNT_19 => (self.STUNT_19, self.STUNT_19_unlim),
            Area::EBO_M40AA => (self.EBO_M40AA, self.EBO_M40AA_unlim),
            Area::STUNT_31B => (self.STUNT_31B, self.STUNT_31B_unlim),
            Area::EBO_M40AD => (self.EBO_M40AD, self.EBO_M40AD_unlim),
            Area::STUNT_18 => (self.STUNT_18, self.STUNT_18_unlim),
            Area::STUNT_35 => (self.STUNT_35, self.STUNT_35_unlim),
            Area::STUNT_42 => (self.STUNT_42, self.STUNT_42_unlim),
            Area::STUNT_44 => (self.STUNT_44, self.STUNT_44_unlim),
            Area::STUNT_34 => (self.STUNT_34, self.STUNT_34_unlim),
            Area::STUNT_50A => (self.STUNT_50A, self.STUNT_50A_unlim),
            Area::STUNT_54A => (self.STUNT_54A, self.STUNT_54A_unlim),
            Area::STUNT_55A => (self.STUNT_55A, self.STUNT_55A_unlim),
            Area::STUNT_56A => (self.STUNT_56A, self.STUNT_56A_unlim),
            Area::STUNT_57A => (self.STUNT_57A, self.STUNT_57A_unlim),
            Area::BastilaSaved => (self.BastilaSaved, false),
